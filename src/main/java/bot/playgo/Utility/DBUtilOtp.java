...
//            List results = query.getResultList();
            ...
            for (Object[] row : results) {
                ...
                PlaygoApplication.logger.info("Generated OTP : " + otp);
            }
    ...
    private static boolean isCurrentOtpEntryDateNewer(String entryDate) throws ParseException {
        ...
        PlaygoApplication.logger.info("<< Comparing Formatted OTP Entry Date - Request Timestamp >>");
        PlaygoApplication.logger.info("Request Timestamp  = " + Components.formattedRequestTimestamp);
        PlaygoApplication.logger.info("OTP Entry Date = " + formattedEntryDate);
