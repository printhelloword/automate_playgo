...
//            List results = query.getResultList();
            ...
            for (Object[] row : results) {
                ...
                MlbbApplication.logger.info("Generated OTP : " + otp);
            }
    ...
    private static boolean isCurrentOtpEntryDateNewer(String entryDate) throws ParseException {
        ...
        MlbbApplication.logger.info("<< Comparing Formatted OTP Entry Date - Request Timestamp >>");
        MlbbApplication.logger.info("Request Timestamp  = " + Components.formattedRequestTimestamp);
        MlbbApplication.logger.info("OTP Entry Date = " + formattedEntryDate);
