...
public class RequestListener {
    ...
    private void setRequestTimestamp() {
        try {
            ...
            AovApplication.logger.info("Set Timestamp -> " +Components.formattedRequestTimestamp);
        } catch (Exception e) {
    ...
    private void printRequest(Request request) {
        AovApplication.logger.info("====== Incoming Request ===== trx/" + request.mergedRequestSeparatedBySlash() + "/");
    }
