...
public class RequestListener {
    ...
    private void setRequestTimestamp() {
        try {
            ...
            CodMobileApplication.logger.info("Set Timestamp -> " +Components.formattedRequestTimestamp);
        } catch (Exception e) {
    ...
    private void printRequest(Request request) {
        CodMobileApplication.logger.info("====== Incoming Request ===== trx/" + request.mergedRequestSeparatedBySlash() + "/");
    }
