...
public class Components {
    ...
    static Map<String, String> getDenominationsIdMap() {
        ...
        denominationMap.put("26", "498");
        denominationMap.put("53", "499");
        denominationMap.put("106", "500");
        denominationMap.put("264", "501");
        denominationMap.put("528", "502");
        denominationMap.put("1056", "503");
