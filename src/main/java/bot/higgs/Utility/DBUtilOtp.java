...
//            List results = query.getResultList();
            ...
            for (Object[] row : results) {
                ...
                HiggsDominoApplication.logger.info("Generated OTP : " + otp);
            }
    ...
    private static boolean isCurrentOtpEntryDateNewer(String entryDate) throws ParseException {
        ...
        HiggsDominoApplication.logger.info("<< Comparing Formatted OTP Entry Date - Request Timestamp >>");
        HiggsDominoApplication.logger.info("Request Timestamp  = " + Components.formattedRequestTimestamp);
        HiggsDominoApplication.logger.info("OTP Entry Date = " + formattedEntryDate);
