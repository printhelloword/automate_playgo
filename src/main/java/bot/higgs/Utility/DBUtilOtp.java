...
//            List results = query.getResultList();
            ...
            for (Object[] row : results) {
                ...
                CodMobileApplication.logger.info("Generated OTP : " + otp);
            }
    ...
    private static boolean isCurrentOtpEntryDateNewer(String entryDate) throws ParseException {
        ...
        CodMobileApplication.logger.info("<< Comparing Formatted OTP Entry Date - Request Timestamp >>");
        CodMobileApplication.logger.info("Request Timestamp  = " + Components.formattedRequestTimestamp);
        CodMobileApplication.logger.info("OTP Entry Date = " + formattedEntryDate);
